...
//
//  // Configure the first filter for RxFIFO0
//  canfilterconfig0.FilterActivation = CAN_FILTER_ENABLE;
//  canfilterconfig0.FilterBank = 0;  // Choose a suitable filter bank
//  canfilterconfig0.FilterFIFOAssignment = CAN_RX_FIFO0;
//  canfilterconfig0.FilterIdHigh = 0x103 << 5;  // Set the ID you want to allow (0x102)
